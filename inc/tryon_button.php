...
/**
 * Add Try on button on product details page after add to cart button
 */
			...
			<div id="gvtryon_modal_inner">
				<div id="container" class="gvtryon_content_wrap">
					...
					<div id="gvtryon_vid_container">
						<video id="gvtryon_video" autoplay playsinline></video>
						<div id="gvtryon_video_overlay"></div>
						<canvas id="gvtryon_video_canvas"></canvas>
						<canvas id="gvtryon_video_cap_canvas"></canvas>
					</div>
						...
						<ul>
							<li class="mode">
								<span class="switch-wrap  showIfCameraStart">
									...
									<input type="checkbox" id="gvt_mode_check" checked /><label for="gvt_mode_check">Mode</label>
									<span class="switch-title right">Video</span>
								</span>
							</li>
							<li>
								<button id="gvtryon_start_camera_button" class="tooltip" type="button">
									<span class="tooltiptext">Start Camera</span>
								</button>
							</li>
							<li>
								<button id="gvtryon_stop_camera_button" class="tooltip" type="button">
									<span class="tooltiptext">Stop Camera</span>
								</button>
							</li>
							<li>
								<button id="gvtryon_switch_camera_button" class="tooltip" name="switch Camera" type="button"
									aria-pressed="false">
									<span class="tooltiptext">Switch</span>
								</button>
							</li>
							<li>
								<button id="gvtryon_take_photo_button" class="showIfCameraStart tooltip" name="take Photo"
									type="button">
									<span class="tooltiptext">Take Photo</span>
								</button>
							</li>
							<li>
								<button id="gvtryon_set_frame_photo_button" class="showIfCameraStart tooltip"
									name="Set Frame Photo" type="button">
									<span class="tooltiptext">Set Frame</span>
								</button>
							</li>
							<li class="showifovelayhaseframe">
								<button id="gvtryon_clear_frame_button" name="Clear Frame" class="tooltip" type="button">
									<span class="tooltiptext">Clear Frame</span>
								</button>
							</li>
							<li>
								<button id="gvtryon_toggle_full_screen_button" name="toggle FullScreen"
									class="showIfCameraStart tooltip" type="button" aria-pressed="false">
									<span class="tooltiptext">FullScreen</span>
								</button>
							</li>
							<li>
								<button id="gvtryon_download_snap" name="gvtryon_download_snap"
									class="showIfCameraStart tooltip" type="button">
